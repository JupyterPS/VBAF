...
$form.Text = 'FjernvarmeChart 2020'
...
$listBox.Height = 135
                 ...
                 [void]$Chart.Titles.Add("                                      FJERNVARMECENTRALEN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            .            .$yea1                                          .$yea2                                     .$yea3")
                 ...
                 ############################################################################################################
                 Invoke-expression -Command $basePath\FO_FJ3ÅrsforbrugChart1.ps1
                 ############################################################################################################
                 ...
                 $array = (0,3,6,9,12,15,18,21,24,27,30,33)
                      if ($Count -in $array)
                      {                                   
                           if ($yea1 -ge 2020 -and $year -le $ThisYear)
                           {  
                 ...
                 $array = (1,4,7,10,13,16,19,22,25,28,31,34)
                      if ($Count -in $array)
                      {                            
                           if ($yea2 -ge 2021 -and $year -le $ThisYear)
                           {  
                 ...
                 $array = (2,5,8,11,14,17,20,23,26,29,32,35)
                      if ($Count -in $array)
                      {                               
                           if ($yea3 -ge 2022 -and $year -le $ThisYear)
                           {  
                 ...
                 ##################################################################################################
                 Invoke-expression -Command $basePath\FJ_FullChart.ps1
                 ##################################################################################################
